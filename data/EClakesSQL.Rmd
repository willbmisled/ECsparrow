...
```{r R2002m2, include=FALSE, echo=FALSE, cache=TRUE}
      ...
      #connection info
        EClakes<-dbConnect(SQLite(), dbname='EClakes.sqlite')
      #read the SAS file
        R2002m2<-read.sas7bdat("C:/Bryan/EPA/Data/Sparrow/EastCoast/Predictions20140923/mrb2_massbalancereservoirs_2002.sas7bdat")
...
```{r R2020m2, include=FALSE, echo=FALSE, cache=TRUE}
      ...
      #connection info
        EClakes<-dbConnect(SQLite(), dbname='EClakes.sqlite')
      #read the SAS file
        R2020m2<-read.sas7bdat("C:/Bryan/EPA/Data/Sparrow/EastCoast/Predictions20140923/mrb2_massbalancereservoirs_2020.sas7bdat")
      #rename "MOFLOWU" to "TOT_CFS" to match MRB1
